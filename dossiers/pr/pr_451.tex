...
\section{Projet pédagogique au sein du département informatique de l'UFR }
...
Le projet que j'aimerais promouvoir est l'élargissement du recrutement étudiant.

Le problème de la baisse des effectifs est posé à toutes les filières scientifiques.
Cependant, les formations en informatique de l'UFR peuvent bénéficier de deux atouts.
D'une part, le marché de l'emploi très actif dans le secteur des technologies de la 
communication peut permettre de développer encore les relations avec les entreprises
et accroître l'attractivité auprès des étudiants. D'autre part, la réputation de 
l'Université de Strasbourg permet d'envisager une plus large publicité des formations 
à l'étranger.


\subsection{Relations avec le monde professionnel}

Concernant les relations avec les entreprises, le passage du master Ingénierie du 
Logiciel et des Connaissances (ILC) en alternance a certainement marqué une nouvelle
étape qui amène le département a renforcer des relations avec les entreprises. 
Le recrutement en 2011 d'une chargée de communication et des relations entreprise en 
atteste. De même, le succès de cette formation auprès des étudiants ne se dément pas
et la formation est même passée en alternance sur les deux années du master en 2010. 
J'ai le sentiment que cette attractivité de l'alternance bénéficiera sur le long terme  
à l'ensemble des formations, car elle renforce la réputation du département en matière
de liens avec le monde professionnel, et donc d'apportunités professionnelles pour
les étudiants. Cette perception, si elle se répand, pourrait convaincre plus d'étudiants
de s'inscrire en licence informatique.
D'autres actions sur le mouyen terme pourraient également accroître  

Cependant, le risque est que la formation par alternance déséquilibre l'orientation
en asséchant les autres filières. D'autres avantages doivent pouvoir être mis en
avant pour des formations de master plus orientées vers la recherche. 


Le projet que j'aimerais promouvoir si j'étais recruté à l'UFR
enseignant l'informatique serait la construction d'un programme international.
Mon établissement de rattachemet actuel propose un cursus en formation initiale 
...
Réciproquement, l'établissement reçoit de nombeux  étudiants étranger en échange, qui 
