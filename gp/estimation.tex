...
\item La charge est souvent pondérée par coefficient de productivité
\end{itemize}
\vspace{.6cm}
...
%*****************************************************************
\frame{\frametitle{Unité de charge corrigée}
\underline{Exemple de correction de productivité} :
\begin{center}	
