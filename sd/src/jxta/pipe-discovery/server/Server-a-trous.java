...
public class Server {
    ...
    private void startServer() {
		...
		// On essaie de lire l'advertisment de ppipe dans le fichier FILENAME
		try {
			  System.out.println("Reading pipe advertisement " + FILENAME);
			  ...
			  try {
				    ...
				    System.out.println("** failed reading advertisment.");
				    e.printStackTrace();
				    System.exit(-1);
			  }
    ...
    private void readMessages() {
		...
		while (true) { 
			  ...
			  try {                
				    ...
				    // Si erreur, fermer le pipe
				    myPipe.close();
				    return;
			  }
			  // Si le message est vide			
			  if (msg == null) {
				    System.out.println("--> Got an empty message.");
			  }
			  else {
				    ...
				    if (el == null)
						...
						System.out.println("Got:[" + el.toString()+"]");
			  }
