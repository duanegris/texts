...
\item Pour les processus de catégorie (i) il existe des fichiers prospects 
	...
	prospects diplômés      & service diplômés &  import csv, base de donnée \\
	étudiants de la CRD 	& import APOGEE & \\
	journalistes 		& contact personnel	& carnet d'adresse \\
	\hline
	\end{itemize}
	Ceux-ci  ont pu être constitués par 
      la collecte des informations saisies par un participant
...
est hétéroclite, peu pérenne, faiblement collaborative et pourrait
certainement gagner en efficacité. 
