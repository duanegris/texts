...
Deux processus sont en interaction complète avec le système d'information. 
La partie du système d'information concernée est très centrée sur la base 
des entreprises et des contacts à l'intérieur de ces entreprises.
\begin{itemize}
...
\item[$\bullet$] RE-2) L'enrichissement de la base de données entreprises.
\end{itemize}
...
en stage et apprentissage serait régulièrement exportés (fréquence 
