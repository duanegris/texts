...
\paragraph{Fatiha Bouterâ (FB), Maxime Merli (MM)} 
...
impliquent souvent un \textbf{historique}, comme par exemple nombre de 
...
pour l'objectif d'une accréditation AACSB à l'automne 2014. Le S.I. devrait
...
seront offertes par le futur S.I. \motcle{Alisée} de l'UdS.
...
\bigskip
\textit{Les trois diecteurs délégués, pour les Master Universitairesi (MU), Executive 
Eductation (EE) et Programme Grandé \'Ecole (PGE) respectivement, ont été audités 
séparément.}

\subsection{Processus fonctionnels}
\begin{itemize}
\item[$\bullet$] PP-1) Faire connaître les formations et solliciter des candidatures.
\item[$\bullet$] PP-2) Structurer la maquette pédagogique.
...
PP-2) fait actuellement l'objet d'un effort collectif dans les différents programmes.
